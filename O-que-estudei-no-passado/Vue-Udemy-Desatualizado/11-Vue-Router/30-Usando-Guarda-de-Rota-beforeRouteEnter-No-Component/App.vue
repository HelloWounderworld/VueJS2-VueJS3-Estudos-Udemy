...
// Nessa trigésima aula, vamos aprender a trabalhat com a guarda de rota "beforeRouteEnter" (No component), donde a tal implementação ocorreu no index.js na rota contatos editar e no arquivo ContatoEditar.vue
</script>
