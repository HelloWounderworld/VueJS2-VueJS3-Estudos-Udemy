<template>
  <div id="app" class="container">
    ...
    <button @click="componentSelecionado = 'AssincronoComponent'">Assincrono</button>
...
// import AssincronoComponent from './components/AssincronoComponent.vue'
...
export default {
  components: {
    // AssincronoComponent: () => import('./components/AssincronoComponent.vue'),
    AssincronoComponent: () => ({
      // component: import('./components/AssincronoComponent.vue'),
      component: new Promise((resolve, reject) => {
        setTimeout(() => {
          // resolve(import('./components/AssincronoComponent.vue'))
